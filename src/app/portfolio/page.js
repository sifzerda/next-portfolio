...
export default function PortfolioPage() {
  ...
  const apps = [
    ...
    },
    {
      ...
      description: "A game of 8 ball billiards. A fullstack app, built with React, Express, Node js, MongoDB, graphql, and Matter.js physics engine - refactored into a serverless Next app + Prisma db. Users can sign up, submit and view their best scores on their profile.",
      image: "/poolPic.jpg",
    ...
    {
      title: "Asteroids",
      description: "The retro arcade game Asteroids. A fullstack app, built with React, Express, Node js, MongoDB, graphql, and Matter.js physics engine - refactored into a serverless Next app. Users can sign up, submit and view their best scores on their profile.",
      image: "/aster.jpg",
    ...
    {
      title: "Solitaire",
      description: "The card game Solitaire. A fullstack app, built with React, Express, Node js, MongoDB and graphql - refactored into a serverless Next app. Users can sign up, submit and view their best times on their profile.",
      image: "/solPic.jpg",
    ...
    {
      title: "Minesweeper",
      description: "A game of Minesweeper in serverless Next.js. Originally built with React, Express, MongoDB and graphQL - refactored into a serverless Next app.",
      image: "/mine.jpg",
    ...
    {
      title: "Horror Map",
      description: "This (unfinished) blog site provides a guide for horror fiction-writing. Formerly built in React using MongoDB and graphql and deployed on Heroku, then refactored into a serverless SPA Router App in Next.js. Users can sign up and leave comments on each page.",
      image: "/horrormap.jpg",
    ...
    {
      title: "Fiction Map",
      description: "This (unfinished) blog site provides a guide for fiction-writing. Formerly built in React using MongoDB and graphql and deployed on Heroku, then refactored into a serverless SPA Router App in Next.js using Postgres-Neon DB. Users can sign up and leave comments on each page.",
    ...
    },
    {
      ...
      description: "AText Editor app built with Javascript, HTML and CSS, on an Express Server. It utilizes PWA technologies, including Webpack, a Service Worker, and IndexedDB for use and storage offline. Deployed on Render.",
      image: "/jate.jpg",
