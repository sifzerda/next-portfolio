...
return ( 
  ...
  <div ref={nodeRef} className="w-full max-w-5xl border border-zinc-300 bg-[radial-gradient(circle_at_top_left,_rgba(26,75.41,207,1.0),_transparent_60%)] rounded-sm overflow-hidden cursor-move" > 
  ...
  <div> <div className="flex items-center justify-between mb-6 uppercase text-[11px] tracking-[0.3em] text-zinc-100 font-semibold"> 
  <span>Next Gen</span> 
  <span>Learning:</span> 
  </div> 
  <h1 className="text-[#2cff66] uppercase leading-[0.85] tracking-tight font-black text-5xl sm:text-6xl md:text-7xl max-w-3xl" style={{ fontFamily: "Impact, Haettenschweiler, Arial Narrow Bold, sans-serif", textShadow: "0 0 12px rgba(44,255,102,0.35)", }} > Beyond The <br /> Virtual <br /> Classroom </h1> 
  </div> 
  <div className="mt-12 flex gap-3 max-w-md"> 
    <div className="pt-1 text-zinc-200 text-xl">▶</div> 
    <p className="text-[11px] sm:text-xs uppercase leading-relaxed tracking-[0.15em] text-zinc-200 max-w-xs"> Explore new learning frameworks, digital habits, and design strategies that redefine the next generation of learners. </p> 
    </div> 
    </div> 
    </div> 
